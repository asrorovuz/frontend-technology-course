    ...
    <header>
        <div className="d-flex header">
            ...
            <div className="navbar d-flex">
              <ul className='d-flex'>
                  <li><CustomLink to={'/'}>Bosh sahifa</CustomLink></li>
                  <li><CustomLink to={'/doc'}>Manbalar</CustomLink></li>
                  <li><CustomLink to={'/course'}>Kurslar</CustomLink></li>
                  <li><CustomLink to={'/about'}>Biz haqimizda</CustomLink></li>
                  <li><CustomLink to={'/contact'}>Aloqa</CustomLink></li>
              </ul>
              <div className="admin">
